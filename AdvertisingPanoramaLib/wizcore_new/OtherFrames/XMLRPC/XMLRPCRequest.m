...
//    static int i = 0;
//    
//    NSString* fileName = [[WizFileManager documentsPath] stringAppendingPath:[NSString stringWithFormat:@"%d.xml", i++]];
//    
//    [body writeToFile:fileName useUtf8Bom:YES error:nil];
