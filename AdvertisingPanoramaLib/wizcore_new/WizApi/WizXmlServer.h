...
extern NSString* const SyncMethod_GetMessages;
extern NSString* const SyncMethod_SetReadStatus;
//
static NSString* const SyncMethod_DocumentGetData = @"document.getData";
extern NSString* const WizXmlSyncStateChangedKey;
//
static NSString* const SyncMethod_GetKMUserList = @"accounts.getValue";
...
typedef NS_ENUM(NSInteger, WizXmlSyncState) {
    ...
    WizXmlSyncStateWillDownloadFolders = 13,
    WizXmlSyncStateWillDownloadTags = 14,
    WizXmlSyncStateWillDownloadAttachments = 15,
    WizXmlSyncStateWillDownloadDocuments = 16,
    WizXmlSyncStateWillUploadAllChanges = 17,
    WizXmlSyncStateDidUploadAllChanges = 18,
    WizXmlSyncStateWillUploadDeletedList = 19,
    WizXmlSyncStateWillUploadTagsList = 20,
    WizXmlSyncStateWillDownloadDeletedList = 21,
    WizXmlSyncStateWillUploadDocuments = 22,
    WizXmlSyncStateWillUploadAttachments = 23,
