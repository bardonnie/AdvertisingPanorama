...
static NSString* const WizNetWorkActivityIndicatorStatueChanged = @"WizNetWorkActivityIndicatorStatueChanged";
static NSString* const KeyOfIndicatorStatue = @"KeyOfIndicatorStatue";
