...
inline std::string IntToString(int a, unsigned int base = 10)
{
...
inline std::string IntToString(short a, unsigned int base = 10)
{
...
inline std::string IntToString(char a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(long a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(long long a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(unsigned char a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(unsigned short a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(unsigned int a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(unsigned long a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
...
inline std::string IntToString(unsigned long long a, unsigned int base = 10)
{
	if (a == 0)
		return "0";
	bool negate = false;
	...
	while (a > 0)
	{
		unsigned long long digit = a % base;
		result = char((digit < 10 ? '0' : ('a' - 10)) + digit) + result;
		a /= base;
	}
	if (negate)
