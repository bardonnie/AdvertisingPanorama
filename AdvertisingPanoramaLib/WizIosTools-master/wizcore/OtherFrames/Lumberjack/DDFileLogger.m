...
- (NSString *)formatLogMessage:(DDLogMessage *)logMessage
{
	...
	return [NSString stringWithFormat:@"%@::%s[%d][%s]:Date:%@  M:%@",logMessage->threadName, logMessage->file,logMessage->lineNumber ,logMessage->function, dateAndTime, logMessage->logMsg];
}
