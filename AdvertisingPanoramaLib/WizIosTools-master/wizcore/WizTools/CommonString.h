...
//
#define WizRecordAttachmentNamePrefix @"wizOpenRecordattAchmentIphoneIpad_"
...
#define WizStrPersonalGroups        NSLocalizedString(@"Personal Group",nil)
...
#define WizStrDeleteForever         NSLocalizedString(@"Delete Forever", nil)
...
#define WizStrContinue              NSLocalizedString(@"Continue", nil)

#define WizStrPrint                 NSLocalizedString(@"Print", nil)
...
#define WizStrSearching             NSLocalizedString(@"Searching...",nil)
...
#define WizStrIfyouchoosetoeditthisdocument                 NSLocalizedString(@"Note format was too complex and can not be edited, and will use the old editor.If you choose to edit this note, images and text-formatting will be lost. Continue?", nil)
...
#define WizStrPleaseenterthepasswordagain               NSLocalizedString(@"Please Re-enter password", nil)
...
#define WizStrNotesLoading                              NSLocalizedString(@"Syncing...",nil)
...
#define WizStrReduction  NSLocalizedString(@"Reduction", nil)
//
...
#define WizStrMessage           NSLocalizedString(@"Message",nil)
#define WizStrShareToWizGroup   NSLocalizedString(@"Share By Wiz",nil)

#define WizStrReleaseToNextNote          NSLocalizedString(@"Release to view next note",nil)
#define WizStrReleaseToPreviousNote      NSLocalizedString(@"Release to view previous note",nil)

#define WizStrDragUpToNextNote          NSLocalizedString(@"Drag up to load next note",nil)
#define WizStrDragDownPreviousNote      NSLocalizedString(@"Drag down to load previous note",nil)

#define WizStrNoneNextNote      NSLocalizedString(@"Has been the last note",nil)
#define WizStrNonePreviousNote  NSLocalizedString(@"Has been the first note",nil)

#define WizNeedTokenStringIdentify   @"WizNeedTokenStringIdentify"

#define WizStrSyncing                                   NSLocalizedString(@"Syncing...",nil)
#define WizStrDeletedItems            NSLocalizedString(@"Deleted Items",nil)  
#define WizStrActiveKbGuidForSettings   @"WizStrActiveKbGuidForSettings"
#define WizStrAllMessages       NSLocalizedString(@"All Messages", nil)

#define WizStrDocumentListUnSyncedSectionTitle NSLocalizedString(@"Unsync", Nil)
#define WizStrBack NSLocalizedString(@"Back",nil)
...
extern "C"
{
    ...
    NSString* getFolderDisplayName(NSString* folderName);
#ifdef __cplusplus
}
#endif
